...
INSERT INTO Items (itemID, name, unitPrice, calorie, description, picURL) VALUES (1, 'Caffè Americano', 1.2, 15, 'Espresso shots topped with hot water create a light layer of crema culminating in this wonderfully rich cup with depth and nuance.', 'https://globalassets.starbucks.com/assets/f12bc8af498d45ed92c5d6f1dac64062.jpg?impolicy=1by1_wide_1242');
...
INSERT INTO Items (itemID, name, unitPrice, calorie, description, picURL) VALUES (4, 'Caffè Mocha', 2.95, 360, 'Our rich, full-bodied espresso combined with bittersweet mocha sauce and steamed milk, then topped with sweetened whipped cream. The classic coffee drink that always sweetly satisfies.', 'https://globalassets.starbucks.com/assets/f4ec500b34624242b15c2d29e53f3c48.jpg?impolicy=1by1_wide_1242');
INSERT INTO Items (itemID, name, unitPrice, calorie, description, picURL) VALUES (5, 'Flat White', 2.39, 170, 'Smooth ristretto shots of espresso get the perfect amount of steamed whole milk to create a not-too-strong, not-too-creamy, just-right flavor.', 'https://globalassets.starbucks.com/assets/fedee22e49724cd09fbcc7ee2e567377.jpg?impolicy=1by1_wide_1242');
